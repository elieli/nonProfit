	...
	*/	
	...
	function createNewWindow(width,height,left,top)
	{
		...
		img.src = '/admin/images/winImages/top_left.gif';
		img.align='left';
		topDiv.appendChild(img);
		
		var img = document.createElement('IMG');
		img.src = '/admin/images/winImages/top_center.gif';
		...
		var img = document.createElement('IMG');
		img.src = '/admin/images/winImages/minimize.gif';
		img.className='minimizeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = '/admin/images/winImages/close.gif';
		img.className='closeButton';
		buttonDiv.appendChild(img);	
		
		var img = document.createElement('IMG');
		img.src = '/admin/images/winImages/top_right.gif';
		buttonDiv.appendChild(img);		
		...
		var img = document.createElement('IMG');
		img.src = '/admin/images/winImages/bottom_right.gif';
