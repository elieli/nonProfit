...
public partial class orgProducts : System.Web.UI.Page
{
    ...
    // orgItems   obj = new orgItems();
      ...
      int orgid =   BLOrganization.orgID;// ((BLCustomer)messages.cust).Organization.ID;
   ...
   ///   ds =            messages.UpdateDonate("I", "get_Items", 0, catid, orgid, txtItemSearch.Text.Trim());
      ...
      ds = BLItems.GetItemsList(param, "get_Items", 0, orgid, catid, "");
  ...
  orgStatus,orgVideo);
    ...
    public  DataSet getItems(String parm, string commandtext, int id, int orgid, int catid, string status)
    {
