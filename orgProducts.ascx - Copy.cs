...
public partial class orgItems : System.Web.UI.UserControl
{
    ...
    protected void loads()
    {
        ...
        else
        {
            ...
            ds = org.Orgitems.UpdateDonate("Q", "get_Items", 0, catid, orgid, "");
        ...
        switch (e.Item.ItemType)
        {
            ...
            case ListItemType.AlternatingItem:
               ...
               /// btnwatch.Attributes.Add("onClick", "javascript:return watch(" + auctionid + ");");
                ...
                HtmlGenericControl title = (HtmlGenericControl)e.Item.FindControl("title");
                title.InnerHtml = ((DataRowView)e.Item.DataItem)["title"].ToString();
    ...
    protected void BreadCrumbLink_Click(Object sender, EventArgs e)
    {
        ...
        BLItems.catid = Convert.ToInt16(dir);
