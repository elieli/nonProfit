...
public partial class OrgForm : System.Web.UI.Page
{
   ...
   public  String SubGmachTitle = "";
    ...
    protected void Update_Donate()
    {
     ...
     //   HtmlForm frm = (HtmlForm)MainContent.FindControl("form1");
       ...
       //////////// String orgEmail = ((HtmlInputControl)MainContent.FindControl("orgEmail")).Value;//   (String)Request.Form["orgEmail"] == null ? "0" : (String)Request.Form["orgEmail"].ToString();)
       ...
       //////////// String orgPaypal = ((HtmlInputControl)MainContent.FindControl("orgPayPalAccount")).Value;//   (String)Request.Form["orgPayPalAccount"] == null ? (String)Request.Form["orgPayPalAccount"].ToString() : (String)Request.Form["orgPayPalAccount"].ToString();
       ...
       //////////// String flashCenter = (((HtmlContainerControl)MainContent.FindControl("dvFlashCentertxt"))).InnerHtml;//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();
        ...
        String orgEmail =   (String)Request.Form["orgEmail"] == null ? "0" : (String)Request.Form["orgEmail"].ToString(); 
        // String subtype = ((HtmlInputControl)this.FindControl("orgEmail")).Value;//  (String)Request.Form["subtype"] == null ? "0" : "1";// (String)Request.Form["subtype"] == null ? Request.Form["subtype"].ToString() : Request.Form["subType"].ToString();
        String orgTitle =   (String)Request.Form["orgTitle"] == null ? "" : (String)Request.Form["orgTitle"].ToString();

        String orgFunct =  (String)Request.Form["orgFucnionality"] == null ? "" : (String)Request.Form["orgFucnionality"].ToString();
        String orgDesc = (String)Request.Form["orgDescription"] == null ? "" : (String)Request.Form["orgDescription"].ToString();
        String orgTaxID = (String)Request.Form["orgTaxID"] == null ? "" : (String)Request.Form["orgTaxID"].ToString();
        String orgAddress = (String)Request.Form["orgAddress"] == null ? "" : (String)Request.Form["orgAddress"].ToString();

        String orgPaypal = (String)Request.Form["orgPayPalAccount"] == null ? "" : (String)Request.Form["orgPayPalAccount"].ToString();

        String orgLogo = (String)Request.Form["orgLogo"] == null ? "" : (String)Request.Form["orgLogo"].ToString();

        String buttonLogo = (String)Request.Form["buttonLogo"] == null ? "" : (String)Request.Form["buttonLogo"].ToString();
     ...
     ///////   drplstStates
       ...
       /// String  imgCentertxt = (((HtmlContainerControl)MainContent.FindControl("dvimgCentertxt"))).InnerHtml;//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();

       


        String imgCenter = (String)Request.Form["dvimgCentertxt"] == null ? "" : (String)Request.Form["dvimgCentertxt"].ToString(); //  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();
        orgLogo = imgCenter.Substring(imgCenter.LastIndexOf("/")+1  , imgCenter.Length  - (imgCenter.LastIndexOf("/")+1)); 

        String flashCenter = (String)Request.Form["dvFlashCentertxt"] == null ? "" : (String)Request.Form["dvFlashCentertxt"].ToString();//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();

        string flash = flashCenter.Substring(flashCenter.LastIndexOf("/")+1, flashCenter.Length - (flashCenter.LastIndexOf("/")+1));




        String hdnOrgKnow = (String)Request.Form["hdnOrgKnow"] == null ? "" : (String)Request.Form["hdnOrgKnow"].ToString();//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();


      String []  OrgKnow= hdnOrgKnow.Split('~');

        
        String orgUserid = (String)Request.Form["orgUserid"] == null ? "" : (String)Request.Form["orgUserid"].ToString();//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();
         
        String orgPassword = (String)Request.Form["orgPassword"] == null ? "" : (String)Request.Form["orgPassword"].ToString();//  (String)Request.Form["orgLogo"] == null ? (String)Request.Form["orgLogo"].ToString() : (String)Request.Form["orgLogo"].ToString();
   ...
   int i_d =     r.setOrgs(commandText, prm, idd ,
		 orgTitle  ,
		 orgFunct   ,	
		 orgDesc  ,
	 orgTaxID    ,
	 ...
	 orgPaypal   ,	
	 orgLogo    ,
     orgStatus, flash, orgUserid, orgPassword

    ); 
        
      //  grdvSubGmach.AutoGenerateColumns = false;
   int id_ = i_d;// Convert.ToInt16(ds.Tables[0].Rows[0]["orgId"].ToString());


        for (int w = 0; w < OrgKnow.Length; w++)
        {
            string y = OrgKnow[w];


            r.get_orgKnow("get_orgKnow", "I", id_, y);
      }
