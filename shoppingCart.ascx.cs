...
public partial class shoppingCart : System.Web.UI.UserControl
{
 ...
 /////////BLItems items;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ( items() != null)
        {
           ...
           /// DataSet ds = ((BLItems)messages.cust.Organization.Orgitems).Items;
            ...
            DataSet ds = ((BLItems)items()).Items;
          ...
          ///////      Label Currentpage = (Label)pageing.FindControl("CurrentPage");
                ...
                switch (parent.ToString())
                {
                    case "ASP.orgprofile_aspx":
                     ...
                     case  "ASP.orgwatch_aspx":


                        break;
                     case "ASP.shoppingcart_aspx":
    ...
    protected void rptProductList_OnItemDataBound(object sender, System.Web.UI.WebControls.DataListItemEventArgs e)
    {
        switch (e.Item.ItemType)
        {
            ...
            case ListItemType.AlternatingItem:
                ...
                if (Session["parent"]  !=null  &&  Session["parent"].ToString() == "ASP.orgwatch_aspx") 
                {
                    anchorProfile.HRef = "Auction.aspx?" + "aid=" + ((DataRowView)e.Item.DataItem)["itemAuctionID"].ToString() ;

                    anchorProfile.InnerHtml += "<strong>Veiw Item</strong>";
                }


                //if (((DataRowView)e.Item.DataItem)["Live"].ToString() == "BID")
                //{
                    anchorProfile.HRef = "orgCheckout.aspx?" + "aid=" + ((DataRowView)e.Item.DataItem)["itemAuctionID"].ToString() + "&" + "cid=" + ((DataRowView)e.Item.DataItem)["catid"].ToString() + "&" + "id=" + ((DataRowView)e.Item.DataItem)["itemIDa"].ToString();
             
                    
                anchorProfile.InnerHtml+=   "<strong>Checkout</strong>";
    ...
    protected void emailsub(Object sender, GridViewCancelEditEventArgs e)
    {
        ...
        UpdateDonate("S", "get_Items",custs().ID, catid, orgid, "");
