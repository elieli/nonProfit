...
public partial class orgOrders : System.Web.UI.Page
{
 ...
 ////////// BLItems items = (BLItems)messages.cust.Organization.Orgitems;
    ...
    {
        DataSet dst = BLOrders.returnOrders;
        ...
        /// DataSet dst = (DataSet)  dtalstItems.DataSource  ;
        filters = "";
        DataView dv = new DataView(dst.Tables[0]);



        DateTime Start = (DateTime) Convert.ToDateTime(txtstartDate.Text);


        DateTime End = (DateTime)Convert.ToDateTime(txtstartDate.Text);
        ...
        if (Start != null && End != null)
        {
            ...
            filters = "ordr_created >= '" + Start + "' and  ordr_created <= '" + End +"'";
   ...
   //startDate
        ...
        {
            DateTime filterDate = DateTime.Now.AddDays(-Convert.ToInt16(drplstDays.SelectedValue.ToString()));
            ...
            if (filterDate != null)
                filters = "ordr_created >= '" + filterDate + "'";
        }




    if (filters != "" && drplstOrderType.SelectedIndex != -1) filters += " and ";

        filters += "itemStatus = '" + drplstOrderType.SelectedValue.ToString() + "'";
    ...
    protected void showResults(Object sender, EventArgs e)
    {
        ...
        int orgid = orgs().ID; //messages.orgs_.ID;// messages.orgID;
        int catid = items().CatID;// messages.orgs_.Orgitems.CatID;
