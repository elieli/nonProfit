...
.style1 {font-size: 10px}
        ...
        <body>
                        ...
                        <form method="post"  runat="server" id="frmDownLoadSong"  style=" padding:5px; border:solid 3px pink;" action="SubingForm.aspx">
	...
	<tr>
							...
							<tr>
							  ...
							  <td height="28">&nbsp;     <input name="ConfirmImg" value="Confirm"  type="submit" id="ConfirmImg" style="background-image:url('images/right.gif');" runat="server" />
</td>
							</tr>
