<%@ Page Language="C#" AutoEventWireup="true"         CodeFile="BuyersForm.aspx.cs" Inherits="BuyersForm" %>
...
.style1 {font-size: 10px}
        ...
        <body>
                ...
                <div style=" padding-top:20px; ">&nbsp          </div>
                      <table width="400" border="0" align="center" cellpadding="5" cellspacing="5">
									...
									<tr><td> <hr style="color:Yellow;" /></td>   <td height="28" class="titleResults">&nbsp;   Customer Registrationr Form &nbsp; </td>              </tr>
	...
	<tr>
							 ...
							 <tr bgcolor="#F8F8F8">
							  <td height="28">Customer Title: </td>
							...
							<tr bgcolor="#F8F8F8">
							  <td height="28">Customer Funactionality: </td>
							  <td height="28"><input name="orgFucnionality" type="text"  runat="server" size="100" class="verdana11" id="orgFucnionality" /></td>
							</tr>
                            <tr bgcolor="#F8F8F8">
							  <td height="28">Customer Description: </td>
							  <td height="28"><input name="orgDescription"    size="50"  runat="server"     type="text" class="verdana11" id="orgDescription" /></td>
							</tr>
							<!--<tr bgcolor="#F8F8F8">
							...
							<tr bgcolor="#F8F8F8">
							  ...
							  <td height="28"><input name="orgTaxID"   size="50"     runat="server"  type="text" class="verdana11" id="orgTaxID" /></td>
							</tr>
						
						
							<tr bgcolor="#F8F8F8">
							  <td height="28">PayPal  Account</td>
							  <td height="28"><input name="orgPayPalAccount"  size="50"  runat="server"  type="text" class="verdana11" id="orgPayPalAccount" /></td>
							</tr>
							...
							<tr bgcolor="#F8F8F8">
							  <td height="28">Customer Logo</td> <asp:Image  Width="120" Height="120" runat="server" ID="imgCenter_" />
							  <td height="28"><input name="orgLogo"  size="50"   runat="server" type="text" class="verdana11" id="orgLogo" /></td>
							</tr>
						
						
						 
							<tr bgcolor="#F8F8F8">
							  <td height="28">Password</td> <asp:Image  Width="120" Height="120" runat="server" ID="Image1" />
							  <td height="28"><input name="orgLogo"  size="50"   runat="server" type="password" class="verdana11" id="password" /></td>
							</tr>
							...
							<tr>
							  <td height="28">&nbsp;  <input name="buttonLogo" runat="server"  size="50"  onchange="javascript:chgCenterImage('buttonLogo','imgCenter');"  type="file" class="verdana11" id="buttonLogo" /></td>
							  <td height="28">&nbsp;   
