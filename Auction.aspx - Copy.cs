...
public partial class Auction : System.Web.UI.Page
{
    ...
    protected void bidValues(DataRow dr)
    {
     ...
     //   DateTime endDate = Convert.ToDateTime(dr["endDate"].ToString());
        ...
        String buyer_name = messages.buyer_Name;// dr["buyer_name"].ToString();
   ...
   // dss = messages.getItems("Q", "get_Items", 0, catid, orgid, "");
         dss = BLItems.GetItemsList("V", "get_Items", 0, catid, orgid, "");
       ...
       ///  ContentPlaceHolder MainContent = (ContentPlaceHolder)Page.Master.FindControl("Body");
         ...
         pOtherViews.InnerHtml = "you have " + credits_ + " credits ";
        ...
        //}
             ...
             string query1 = Request.QueryString[0] != null ? Request.QueryString[0] : "";
             string query2 = Request.QueryString[1] != null ? Request.QueryString[1] : "";
             string query3 = Request.QueryString[2] != null ? Request.QueryString[2] : "";
    ...
    int   itemids = messages.blitem.ID;// Convert.ToInt16(messages.itemID);
        ...
        int auctionid = messages.blitem.auctionID;


        ds = UpdateDonate("Z", "get_Items", 0, catid, orgid, itemids, "", bidtype, messages.auctionID);
